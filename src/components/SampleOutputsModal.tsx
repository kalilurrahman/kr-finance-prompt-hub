      ...
      >
        ...
        <aside className="w-64 shrink-0 border-r border-border/40 bg-[#070b10] flex flex-col overflow-hidden">
          <div className="px-4 py-4 border-b border-border/30">
            ...
            <p className="text-[10px] text-muted-foreground">30 real prompts · AI-generated</p>
          </div>
          ...
          <div className="p-4 border-t border-border/30">
            <p className="text-[9px] text-muted-foreground/50 text-center">30 outputs generated by Claude 3.5 Sonnet, Gemini 1.5 Pro & Perplexity Sonar Pro</p>
          </div>
        </aside>
