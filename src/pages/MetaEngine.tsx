          ...
          <div className="border-t border-gold/10 px-5 pb-5 pt-4 flex flex-col gap-4">
            ...
            {selected && (
              <div className="rounded-lg border border-gold/20 bg-[#0a0e14]/80">
                ...
                {/* Linked sample output status */}
                <div className="px-4 pb-3 pt-1 flex items-center justify-between gap-2 flex-wrap">
                  {sampleForSelected ? (
                    <div className="flex items-center gap-2 flex-wrap">
                      <span
                        className="inline-flex items-center gap-1 rounded-md border border-emerald-500/40 bg-emerald-500/10 px-2 py-0.5 text-[10px] font-semibold text-emerald-400"
                        title={`Mapped via ${sampleForSelected.matchSource}`}
                      >
                        ✓ Linked to FinPrompt
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-md border border-gold/40 bg-gold/10 px-2.5 py-1 text-[11px] font-semibold text-gold hover:bg-gold/20 transition-colors"
                    ...
                    <span className="inline-flex items-center gap-1 rounded-md border border-amber-500/40 bg-amber-500/10 px-2 py-0.5 text-[10px] font-semibold text-amber-400">
                      ⚠ Not linked — no sample output mapped
                    </span>
                  )}
                  {sampleForSelected && (
